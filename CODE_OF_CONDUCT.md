...
- Any conduct that would reasonably make others feel unwelcome

## Scope

This Code of Conduct applies to all project spaces — GitHub issues, pull requests, discussions, and any other forum associated with this project.
